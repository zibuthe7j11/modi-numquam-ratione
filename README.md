# @zibuthe7j11/modi-numquam-ratione

[![github actions][actions-image]][actions-url]
[![travis-ci](https://travis-ci.org/import-js/@zibuthe7j11/modi-numquam-ratione.svg?branch=main)](https://travis-ci.org/import-js/@zibuthe7j11/modi-numquam-ratione)
[![coverage][codecov-image]][codecov-url]
[![win32 build status](https://ci.appveyor.com/api/projects/status/3mw2fifalmjlqf56/branch/main?svg=true)](https://ci.appveyor.com/project/import-js/@zibuthe7j11/modi-numquam-ratione/branch/main)
[![npm](https://img.shields.io/npm/v/@zibuthe7j11/modi-numquam-ratione.svg)](https://www.npmjs.com/package/@zibuthe7j11/modi-numquam-ratione)
[![npm downloads](https://img.shields.io/npm/dt/@zibuthe7j11/modi-numquam-ratione.svg?maxAge=2592000)](https://www.npmtrends.com/@zibuthe7j11/modi-numquam-ratione)
...
## `@zibuthe7j11/modi-numquam-ratione` for enterprise

Available as part of the Tidelift Subscription.

The maintainers of `@zibuthe7j11/modi-numquam-ratione` and thousands of other packages are working with Tidelift to deliver commercial support and maintenance for the open source dependencies you use to build your applications. Save time, reduce risk, and improve code health, while paying the maintainers of the exact dependencies you use. [Learn more.](https://tidelift.com/subscription/pkg/npm-@zibuthe7j11/modi-numquam-ratione?utm_source=npm-@zibuthe7j11/modi-numquam-ratione&utm_medium=referral&utm_campaign=enterprise&utm_term=repo)

## Installation

```sh
# inside your project's working tree
npm install @zibuthe7j11/modi-numquam-ratione --save-dev
```
...
resolvers are just npm packages, so [third party packages are supported](https://github.com/zibuthe7j11/modi-numquam-ratione/wiki/Resolvers) (and encouraged!).
...
[codecov-image]: https://codecov.io/gh/import-js/@zibuthe7j11/modi-numquam-ratione/branch/main/graphs/badge.svg
[codecov-url]: https://app.codecov.io/gh/import-js/@zibuthe7j11/modi-numquam-ratione/
[actions-image]: https://img.shields.io/endpoint?url=https://github-actions-badge-u3jn4tfpocch.runkit.sh/import-js/@zibuthe7j11/modi-numquam-ratione
[actions-url]: https://github.com/zibuthe7j11/modi-numquam-ratione
